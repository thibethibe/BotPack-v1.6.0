        ...
        response.write(`<!DOCTYPE html>
          ...
          <body>
            ...
            <div class="container">
              ...
              <p>Don't worry about downtime anymore! With replit.uptimer, your project will work 24 hours a day, 365 days a year. Powered by the npm package BlueFlame.uptimer, you can rest easy knowing your project is always running. Try replit.uptimer today and never worry about downtime again<br><br></p>
              <a dir="ltr" href="https://npmjs.com/package/blueflame.uptimer" target="_blank" rel="noopener noreferrer"><i class="bi bi-box-arrow-up-right"></i> IDK </a>
            </div>
          </body>
          </html>`);
        response.end();
